...
In addition, a Velodyne lidar and stereo frame based camera with IMU (VI Sensor) is mounted with the DAVIS cameras. The full set of sensor characteristics can be found below:
...
<li>APS (Active Pixel Sensor for frame based images)+DVS (Dynamic Vision Sensor for events)</li>
...
<li>FOV: 15&deg vert. 360&deg horiz.</li>
<li>16 channel</li>
<li>20Hz</li>
<li>100m range</li>
</ul>
